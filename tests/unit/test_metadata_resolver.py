...
from zotero_cli.core.metadata_resolver import (
...
class TestResolveDoi:
    @patch("zotero_cli.core.metadata_resolver.httpx.get")
    def test_success(self, mock_get: MagicMock) -> None:
        ...
        assert "zotero-cli" in headers["User-Agent"]
    ...
    def test_mailto_added_to_user_agent(self, mock_get: MagicMock) -> None:
        ...
        with patch(
            "zotero_cli.core.metadata_resolver.load_config",
