...
from zotero_cli.commands.add import add_cmd
from zotero_cli.commands.ai_analyze import ai_analyze_cmd
from zotero_cli.commands.attach import attach_cmd
from zotero_cli.commands.cite import cite_cmd
from zotero_cli.commands.collection import collection_group
from zotero_cli.commands.completions import completions_cmd
from zotero_cli.commands.config import config_group
from zotero_cli.commands.delete import delete_cmd
from zotero_cli.commands.duplicates import duplicates_cmd
from zotero_cli.commands.export import export_cmd
from zotero_cli.commands.list_cmd import list_cmd
from zotero_cli.commands.note import note_cmd
from zotero_cli.commands.open_cmd import open_cmd
from zotero_cli.commands.pdf import pdf_cmd
from zotero_cli.commands.read import read_cmd
from zotero_cli.commands.recent import recent_cmd
from zotero_cli.commands.relate import relate_cmd
from zotero_cli.commands.schema import schema_cmd
from zotero_cli.commands.search import search_cmd
from zotero_cli.commands.stats import stats_cmd
from zotero_cli.commands.summarize import summarize_cmd
from zotero_cli.commands.summarize_all import summarize_all_cmd
from zotero_cli.commands.tag import tag_cmd
from zotero_cli.commands.trash import trash_group
from zotero_cli.commands.update import update_cmd
from zotero_cli.commands.update_status import update_status_cmd
from zotero_cli.commands.workspace import workspace_group
...
def main(
    ...
    from zotero_cli.formatter import request_scope
...
def _after_command(ctx: click.Context, *_args: object, **_kwargs: object) -> None:
    ...
    if obj.get("json") or obj.get("no_interaction") or not sys.stderr.isatty():
        return
    from zotero_cli import __version__
    from zotero_cli.core.version_check import check_for_update, upgrade_command
